...
- 🔁 **Prompt Versioning** – Test multiple variations of the same prompt  
- 📊 **Response Evaluation** – Analyze outputs based on predefined metrics  
- ⚖️ **Prompt Comparison** – Compare responses side by side  
- 🧩 **Modular Design** – Easy to extend and customize  
- 🔐 **Secure Configuration** – Environment variable–based API key handling  
